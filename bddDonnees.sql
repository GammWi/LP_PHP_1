...
(2, 'Humain', 'Race qui a inventé la bière et la raclette. Peut aussi réussir les captcha', 15, 15, 20, 50,2),
(3, 'Elfe', 'Les elfes sont une race ancienne, et sont en communion avec la nature. Ils aiment se balader en forêt, insulter des nains et faire des tresses aux poneys. Ah, et ils mangent de la salade aussi', 15, 10, 25, 40,3),
(4, 'Ogre', 'Les ogres sont des créatures massives connues pour leur appétit insasiable et leur intelligence limité. Malgré cela ils sont d\'une loyauté indefectible envers ceux qui arrivent à parler leur étrange language (du moins tant qu\'il y a assez à manger)', 20, 10, 5, 100, 4),
(5, 'Orque', 'Les orques sont des créatures redoutables pour des aventuriers mal prépaprés. Ils servent d\'armée de base aux seigneurs maléfiques et sorciers pour leurs donjons, du fait de leur robustesse et violence au combat (mais ils sont un peu débiles quand même)', 15, 15, 10, 60, 5),
